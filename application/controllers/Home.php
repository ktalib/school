...
class Home extends Frontend_Controller
{
    ...
    public function blogs()
    {
        ...
        $this->data['main_contents'] = $this->load->view('home/blogs', $this->data, true);
        $this->load->view('home/layout/index', $this->data);
    }
    ...
    public function blog_view($id)
    {
        $branchID = $this->home_model->getDefaultBranch();
        $this->data['branchID'] = $branchID;
        $this->data['blog'] = $this->home_model->get('blog', array('id' => $id, 'branch_id' => $branchID, 'status' => 1, 'show_web' => 1), true);
        if (empty($this->data['blog']['id'])) {
            redirect($_SERVER['HTTP_REFERER']);
        }
   
        $this->data['main_contents'] = $this->load->view('home/blog_view', $this->data, true);
        $this->load->view('home/layout/index', $this->data);
    }
