<div class="row">
<?php if (get_permission('blog_type', 'is_add')): ?>
	<div class="col-md-5">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><?=translate('add') . " " . translate('blog_type')?></h4>
			</header>
				...
				<div class="panel-body">
					...
					<div class="form-group mb-xs">
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="bullhorn" checked name="blog_icon" id="bullhorn">
							<label for="bullhorn"><i class="fas fa-bullhorn"></i></label>
						</div>

						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="flag-checkered" name="blog_icon" id="flag">
							<label for="flag"><i class="fas fa-flag-checkered"></i></label>
						</div>

						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="comments" name="blog_icon" id="comments">
							<label for="comments"><i class="fas fa-comments"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="concierge-bell" name="blog_icon" id="concierge-bell">
							<label for="concierge-bell"><i class="fas fa-concierge-bell"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="envelope" name="blog_icon" id="envelope">
							<label for="envelope"><i class="fas fa-envelope"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="comment-alt" name="blog_icon" id="comment-alt">
							<label for="comment-alt"><i class="fas fa-comment-alt"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="users" name="blog_icon" id="users">
							<label for="users"><i class="fas fa-users"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="star" name="blog_icon" id="star">
							<label for="star"><i class="far fa-star"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="stamp" name="blog_icon" id="stamp">
							<label for="stamp"><i class="fas fa-stamp"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
							<input type="radio" value="search" name="blog_icon" id="search">
...
<?php endif; ?>
<?php if (get_permission('blog_type', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('blog_type', 'is_add')){ echo "7"; }else{ echo "12"; } ?>">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="fas fa-list-ul"></i> <?=translate('blog_type') . " " . translate('list')?></h4>
			</header>
			<div class="panel-body">
					...
					<table class="table table-bordered table-hover table-condensed mb-none">
						...
						<tbody>
							...
							<tr>
								...
								<td>
								<?php if (get_permission('blog_type', 'is_edit')): ?>
									<!-- update link -->
								...
								<?php endif; if (get_permission('blog_type', 'is_delete')): ?>
									<!-- delete link -->
									<?php echo btn_delete('blog/type_delete/' . $row['id']);?>
								<?php endif; ?>
								</td>
							</tr>
							<?php
...
<div class="zoom-anim-dialog modal-block modal-block-primary mfp-hide" id="modal">
	<section class="panel">
		<?php echo form_open('blog/types_edit', array('class' => 'frm-submit')); ?>
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-edit"></i> <?=translate('edit') . " " . translate('blog_type')?></h4>
			</header>
			<div class="panel-body">
...
<script type="text/javascript">
	$(document).ready(function () {
		$('.evt_modal').on('click', function() {
			...
			$('#etype_id').val(id);
			$('#ename').val(name);
			$(".frm-submit input[name=blog_icon][value=" + icon + "]").prop('checked', true);
