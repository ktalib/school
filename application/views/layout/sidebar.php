        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    ?>
                    <!-- library -->
                    <li class="nav-parent <?php if ($main_menu == 'library') echo 'nav-expanded nav-active';?>" style="display: none;">
                        <a>
                    ...
                    if (moduleIsEnabled('events')) {
                        ...
                        ?>
                    <!-- envant -->
                    <li class="nav-parent <?php if ($main_menu == 'blog') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="icons icon-speech"></i><span><?=translate('blogs')?></span>
                        </a>
                        <ul class="nav nav-children">
                            <?php if (get_permission('blog_type', 'is_view')) { ?>
                            <li class="<?php if ($sub_page == 'blog/types') echo 'nav-active';?>">
                                <a href="<?=base_url('blog/types')?>">
                                    <span><i class="fas fa-caret-right"></i><?=translate('blog_type')?></span>
                                </a>
                            </li>
                            <?php } if (get_permission('blog', 'is_view')) {  ?>
                            <li class="<?php if ($sub_page == 'blog/index') echo 'nav-active';?>">
                                <a href="<?=base_url('blog')?>">
                                    <span><i class="fas fa-caret-right"></i><?=translate('blogs')?></span>
                                </a>
                            </li>
                            <?php } ?>
                        </ul>
