...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 24, 2024 at 10:42 PM
...
CREATE TABLE IF NOT EXISTS `branch` (
  ...
  `due_with_fine` tinyint NOT NULL DEFAULT '1',
  ...
  `reg_start_from` tinyint NOT NULL DEFAULT '1',
  `institution_code` varchar(100) DEFAULT NULL,
  `reg_prefix_digit` int NOT NULL,
  `offline_payments` tinyint(1) NOT NULL DEFAULT '1',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `unique_roll` tinyint NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `call_purpose` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `branch_id` int NOT NULL,
  PRIMARY KEY (`id`)
...
(1, 1, 'Student ID Card', 1, '110265-orange-wave-free-download-image.png', '', 'Michael-Jordan-personal-autograph1.png', '<br><br><br>\r\n<div style=\"float: left;\">{student_photo} <br> {signature}</div><div style=\"float: right; font-size: 13px; line-height: 1.4;\">Name : <b>{name}</b> <br>Gender : <b>{gender}</b>&nbsp;<b><br></b>Roll :&nbsp; <b>{roll}</b><br>DOB :&nbsp; <b>{birthday}</b> <br>Date of Issue :&nbsp; <b>{print_date}</b> <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{qr_code}</div>', '96.856', '64.0', 1, '110', '5', '5', '20', '20', 'register_no', 1, '2024-02-19 23:05:54');
...
(1, 'Catering', '1', '2024-02-16 23:43:06', NULL, 1),
(2, 'Management Studies', '2', '2024-02-16 23:43:48', NULL, 1);
...
CREATE TABLE IF NOT EXISTS `custom_fields_online_values` (
  `id` int NOT NULL AUTO_INCREMENT,
  `relid` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `disable_reason_details` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `enquiry_follow_up` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `enquiry_reference` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `branch_id` int NOT NULL,
  PRIMARY KEY (`id`)
...
(1, 1, 1, 1, 0, 4, 1, '2024-02-17 00:42:59', NULL),
(2, 2, 1, 1, 67890, 7, 1, '2024-02-18 00:45:34', NULL);
...
(1, 'Full time', 'full-time', '', 1, 0, '2024-02-17 00:25:37'),
(2, 'Part time', 'part-time', '', 1, 0, '2024-02-17 00:26:19');
...
(1, 1, 1, 1, 4, '0.00', '2024-02-17 00:48:06'),
(2, 2, 2, 1, 7, '0.00', '2024-02-18 00:56:20');
...
(1, 'School Fees', '', 4, 0, 1, '2024-02-17 00:28:44'),
(2, 'New student Fees', '', 7, 0, 1, '2024-02-18 00:55:54');
...
(1, 1, 1, '50000.00', '2024-02-17', '2024-02-17 00:28:44'),
(2, 1, 2, '30000.00', '2024-02-17', '2024-02-17 00:28:44'),
(3, 2, 1, '9000.00', '2024-02-23', '2024-02-18 00:55:54');
...
(1, 'Welcome to School', 'St. Rita\'s Catering and , Mangment Institute', 'About Us', '<p><span style=\"font-size: 18px;\">Welcome to St. Rita\'s Catering Institute, where we bring the art of culinary excellence to your fingertips through our innovative online classes. Our virtual platform offers a dynamic learning experience, allowing aspiring chefs and culinary enthusiasts to explore the world of gastronomy from the comfort of their homes.</span><br></p>', 'about1.jpg', 'about1.jpeg', '{\"cta_title\":\"Get in touch to join our community\",\"button_text\":\"Contact Our Office\",\"button_url\":\"contact\"}', '', '', 1);
...
(1, 'Certificates', 'certificates1.jpg', 'Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.', 'St Ritas Catering Institute School Management System With CMS', 'St Ritas Catering Institute School Management System With CMS', 1);
...
(1, 'Exam Results', 1, 1, 'exam_results1.jpg', 'Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.', 'St Ritas Catering Institute  Management System With CMS', 'St Ritas Catering Institute  Admit Card Page', 1);
...
(1, 'Frequently Asked Questions', '<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.</p>\r\n\r\n<p>Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven&#39;t heard of them accusamus labore sustainable VHS.</p>', 'Faq', 'faq1.jpeg', '', '', 1);
...
CREATE TABLE IF NOT EXISTS `front_cms_gallery_content` (
  ...
  `show_web` tinyint NOT NULL DEFAULT '0',
  `branch_id` int NOT NULL,
  `created_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
(5, 'Wellcome To <span>St Ritas Catering Institute</span>', NULL, 'slider', 'Lorem Ipsum is simply dummy text printer took a galley of type and scrambled it to make a type specimen book.', '{\"position\":\"c-left\",\"button_text1\":\"View Services\",\"button_url1\":\"https:\\/\\/www.youtube.com\",\"button_text2\":\"Learn More\",\"button_url2\":\"#\",\"image\":\"home-slider-1708122350.jpeg\"}', NULL, NULL, 1, 1),
(6, 'Online <span>Live Class</span> Facility', NULL, 'slider', 'Lorem Ipsum is simply dummy text printer took a galley of type and scrambled it to make a type specimen book.', '{\"position\":\"c-left\",\"button_text1\":\"Read More\",\"button_url1\":\"#\",\"button_text2\":\"Get Started\",\"button_url2\":\"#\",\"image\":\"home-slider-1708122613.jpg\"}', NULL, NULL, 1, 1),
(7, 'Online Classes', NULL, 'features', 'Immerse yourself in our comprehensive online courses, meticulously crafted by industry experts. Whether you\'re a beginner or a seasoned professional, our diverse range of classes caters to all skill levels. From fundamental cooking techniques to advanced culinary artistry, we provide the tools and knowledge to sharpen your culinary prowess.', '{\"button_text\":\"Read More\",\"button_url\":\"#\",\"icon\":\"fas fa-video\"}', NULL, NULL, 1, 1),
(8, 'Scholarship', NULL, 'features', 'At St. Rita\'s, we believe in nurturing talent. Explore our scholarship programs designed to support passionate individuals with a love for the culinary arts. We are committed to making quality education accessible, ensuring that financial barriers never hinder the pursuit of culinary dreams.', '{\"button_text\":\"Read More\",\"button_url\":\"#\",\"icon\":\"fas fa-graduation-cap\"}', NULL, NULL, 1, 1),
(9, 'Books & Liberary', NULL, 'features', 'Dive into our extensive culinary library, stocked with a wealth of resources to complement your learning journey. From timeless classics to the latest culinary trends, our collection of books offers insights, inspiration, and a deep dive into the world of gastronomy.', '{\"button_text\":\"Read More\",\"button_url\":\"#\",\"icon\":\"fas fa-book-reader\"}', NULL, NULL, 1, 1),
(10, 'Trending Courses', NULL, 'features', 'Stay ahead of the culinary curve with our trending courses that reflect the latest innovations and global gastronomic trends. Our curriculum is continuously updated to encompass emerging techniques, flavors, and styles, ensuring that you are equipped with the knowledge to excel in the ever-evolving world of culinary arts. Embark on a flavorful adventure with St. Rita\'s Catering Institute, where passion meets education, and culinary dreams take flight. Join us on this gastronomic journey, and let the art of cooking become your masterpiece.', '{\"button_text\":\"Read More\",\"button_url\":\"#\",\"icon\":\"fab fa-discourse\"}', NULL, NULL, 1, 1),
...
CREATE TABLE IF NOT EXISTS `front_cms_menu_visible` (
  ...
  `invisible` tinyint NOT NULL DEFAULT '1',
  `branch_id` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3;
...
(2, NULL, 10, NULL, NULL, 1, 1),
(3, NULL, 9, NULL, NULL, 1, 1),
(4, NULL, 13, NULL, NULL, 1, 1),
(5, NULL, 14, NULL, NULL, 1, 1),
(6, NULL, 8, NULL, NULL, 1, 1);
...
(1, 'St Ritas Catering and Management   Institute', 'home', 1, 1, 'red', 'disable', '', '', 'Your Address', '+12345678', '12345678', 'info@example.com', 'info@demo.com', 'Copyright © 2024 <span>St Ritas Catering and Management   Institute</span>. All Rights Reserved.', 'fav_icon1.png', 'logo1.jpeg', 'If you are going to use a passage LorIsum, you anythirassing hidden in the middle of text. Lators on the Internet tend to.', '<span>Hours : </span>  Mon To Fri - 10AM - 04PM,  Sunday Closed', '', '#e1499a', '#ffffff', '#49ade1', '#232323', '#8d8d8d', '#383838', '#8d8d8d', '#262626', '#8d8d8d', '0', 'https://facebook.com', 'https://twitter.com', 'https://youtube.com', 'https://google.com', 'https://linkedin.com', 'https://pinterest.com', 'https://instagram.com', 1);
...
(1, 'Teachers', 'teachers1.jpeg', 'St. Rita\'s Catering and management  Institute,', 'Teachers Page', 1);
...
(1, 'St Ritas Catering Institute', 'SRCI-', 'on', 'ramom@example.com', '', '', 'USD', '$', 'disabled', 7, 'english', '© 2024 St Ritas Catering Institute', 'fadeInUp', 'Africa/Lagos', 'd.M.Y', '', '', '', '', '', 2, 1, 1, 'jpeg, jpg, bmp, png', 2048, 'txt, pdf, doc, xls, docx, xlsx, jpg, jpeg, png, gif, bmp, zip, mp4, 7z, wmv, rar', 'ZDk2MTZhM2EtYTI3Ny00NmMwLWEzNWQtNzMwMDYzYWFkYjgx', 2048, '2024-02-16 20:18:38', '0000-00-00 00:00:00');
...
(137, 'class', 'Department ', 'শ্রেণী', 'صف مدرسي', 'Classe', 'कक्षा', 'Kelas', 'Classe', 'クラス', '수업', 'Klasse', 'Classe', 'ชั้น', 'sınıf', 'کلاس', '类', 'klas', 'Klasse', 'Τάξη', 'Clase', 'कक्षा', 'Учебный класс', 'klasse', 'Դաս', 'Კლასი', 'वर्ग', 'Kelas', 'ਕਲਾਸ', 'வர்க்கம்', 'క్లాస్', 'Klass', 'Klase'),
...
(140, 'subject', 'Course', 'বিষয়', 'موضوع', 'Assujettir', 'विषय', 'Subyek', 'Soggetto', 'テーマ', '제목', 'Onderwerpen', 'Sujeito', 'เรื่อง', 'konu', 'موضوع', '学科', 'Onderwerp', 'Gegenstand', 'Θέμα', 'Tema', 'बिषय', 'Тема', 'Emne', 'Առարկա', 'საგანი', 'विषय', 'Subjek', 'ਵਿਸ਼ਾ', 'பொருள்', 'Subject', 'Ämne', 'Paksa'),
...
(173, 'select_class', 'Select Department ', 'ক্লাস নির্বাচন', 'حدد فئة', 'Sélectionnez la classe', 'वर्ग का चयन', 'Pilih Kelas', 'Seleziona classe', 'クラスを選択します', '선택 클래스', 'Select Class', 'Selecionar classe', 'เลือกชั้นเรียน', 'seçin Sınıf', 'کلاس منتخب', '选择类别', 'Kies klas', 'Wählen Sie Klasse', 'Επιλέξτε τάξη', 'Seleccione clase', 'कक्षा चयन गर्नुहोस्', 'Выберите класс', 'Vælg klasse', 'Ընտրեք դաս', 'აირჩიეთ კლასი', 'वर्ग निवडा', 'Pilih Kelas', 'ਕਲਾਸ ਚੁਣੋ', 'வகுப்பைத் தேர்ந்தெடுக்கவும்', 'తరగతి ఎంచుకోండి', 'Välj klass', 'Piliin ang Klase'),
...
(188, 'subject_author', 'Course Author', 'বিষয় লেখক', 'الموضوع المؤلف', 'Sujet Auteur', 'विषय लेखक', 'Subjek Penulis', 'Autore del soggetto', 'テーマ作成者', '제목 작성자', 'Onderwerp Auteur', 'Assunto Autor', 'ผู้แต่งเรื่อง', 'Konu Yazar', 'موضوع مصنف', '主题作者', 'Vakskrywer', 'Betreff Autor', 'Θέμα Συγγραφέας', 'Autor sujeto', 'विषय लेखक', 'Автор темы', 'Emne forfatter', 'Առարկայի հեղինակ', 'საგნის ავტორი', 'विषय लेखक', 'Pengarang Subjek', 'ਵਿਸ਼ਾ ਲੇਖਕ', 'பொருள் ஆசிரியர்', 'విషయం రచయిత', 'Ämnesförfattare', 'May-akda ng Paksa'),
...
(190, 'class_list', 'Department List', 'ক্লাস তালিকা', 'قائمة الطبقة', 'Liste des classes', 'कक्षा सूची', 'Daftar kelas', 'Lista Class', 'クラス一覧', '클래스 목록', 'class List', 'Lista de Classes', 'รายการระดับ', 'sınıf listesi', 'کلاس کی فہرست', '班级列表', 'Klaslys', 'Klassenliste', 'Λίστα τάξεων', 'Lista de clase', 'वर्ग सूची', 'Список классов', 'Klasseliste', 'Դասերի ցուցակ', 'კლასების სია', 'वर्ग यादी', 'Senarai Kelas', 'ਕਲਾਸ ਲਿਸਟ', 'வகுப்பு பட்டியல்', 'తరగతి జాబితా', 'Klasslista', 'Listahan ng Klase'),
(191, 'class_name', 'Department Name', 'শ্রেণির নাম', 'اسم الطبقة', 'Nom du cours', 'कक्षा का नाम', 'Nama kelas', 'Nome della classe', 'クラス名', '클래스 이름', 'Naam van de klasse', 'Nome da classe', 'ชื่อชั้น', 'Sınıf adı', 'کلاس نام', '类名', 'Klasnaam', 'Klassenname', 'Ονομα τάξης', 'Nombre de la clase', 'कक्षाको नाम', 'Имя класса', 'Klasse Navn', 'Դասի անվանումը', 'კლასის სახელი', 'वर्गाचे नाव', 'Nama Kelas', 'ਕਲਾਸ ਦਾ ਨਾਮ', 'வகுப்பு பெயர்', 'తరగతి పేరు', 'Klassnamn', 'Pangalan ng klase'),
...
(205, 'select_subject', 'Select Course', 'বিষয় নির্বাচন করুন', 'حدد الموضوع', 'Sélectionnez Objet', 'विषय का चयन', 'Pilih Jurusan', 'Selezionare Oggetto', '件名を選択', '선택 주제', 'Selecteer Onderwerp', 'Selecione Assunto', 'เลือกสาขาวิชา', 'Konu seçin', 'موضوع منتخب', '选择主题', 'Kies onderwerp', 'Wählen Sie Betreff', 'Επιλέξτε Θέμα', 'Seleccione Asunto', 'विषय चयन गर्नुहोस्', 'Выберите тему', 'Vælg emne', 'Ընտրեք Առարկան', 'აირჩიეთ თემა', 'विषय निवडा', 'Pilih Subjek', 'ਵਿਸ਼ਾ ਚੁਣੋ', 'பொருள் தேர்ந்தெடுக்கவும்', 'విషయం ఎంచుకోండి', 'Välj ämne', 'Piliin ang Paksa'),
...
(219, 'subjects', 'Courses', 'প্রজাদের', 'المواضيع', 'Sujets', 'विषयों', 'subyek', 'Soggetti', '科目', '주제', 'vakken', 'assuntos', 'อาสาสมัคร', 'Konular', 'مضامین', '主题', 'vakke', 'Themen', 'μαθήματα', 'Asignaturas', 'विषयहरु', 'Предметы', 'emner', 'Առարկաներ', 'საგნები', 'विषय', 'Mata pelajaran', 'ਵਿਸ਼ੇ', 'பாடங்கள்', 'విషయము', 'ämnen', 'Mga Paksa'),
...
(338, 'class_room', 'Department Room', 'ক্লাস রুমে', 'قاعة الدراسة', 'Salle de classe', 'कक्षा के कमरे', 'kelas', 'aula', 'クラスルーム', '교실', 'Klaslokaal', 'Sala de aula', 'ห้องเรียน', 'Sınıf oda', 'کلاس روم', '课室', 'Klas kamer', 'Klassenzimmer', 'ΣΧΟΛΙΚΗ ΑΙΘΟΥΣΑ', 'Aula', 'कक्षा कोठा', 'Класс', 'Klasseværelse', 'Դասասենյակ', 'კლასის ოთახი', 'वर्ग कक्ष', 'Bilik Kelas', 'ਕਲਾਸ ਰੂਮ', 'வகுப்பறை', 'తరగతి గది', 'Klassrum', 'Silid ng Klase'),
...
(1044, 'class_schedule', 'Department Schedule', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
(1140, 'reception', 'Reception', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1141, 'admission_enquiry', 'Admission Enquiry', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1142, 'postal_record', 'Postal Record', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1143, 'call_log', 'Call Log', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1144, 'visitor_log', 'Visitor Log', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1145, 'complaint', 'Complaint', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1146, 'deactivate_reason', 'Deactivate Reason', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1147, 'online_exam', 'Online Exam', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1148, 'question_bank', 'Question Bank', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1149, 'question_group', 'Question Group', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1150, 'my_issued_book', 'My Issued Book', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1151, 'book_issue/return', 'Book Issue/return', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1152, 'offline_payments', 'Offline Payments', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1153, 'payments', 'Payments', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1154, ' offline_payments', ' Offline Payments', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1155, 'login_credential', 'Login Credential', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1156, 'admission_report', 'Admission Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1157, 'class_&_section_report', 'Department & Section Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1158, 'daily_reports', 'Daily Reports', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1159, 'progress', 'Progress', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1160, 'stock', 'Stock', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1161, 'issues', 'Issues', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1162, 'modules', 'Modules', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1163, 'system_student_field', 'System Student Field', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1164, 'february', 'February', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1165, 'today_birthday', 'Today Birthday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1166, 'whatsapp_settings', 'Whatsapp Settings', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1167, 'general_setting', 'General Setting', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1168, 'weekends', 'Weekends', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1169, 'sunday', 'Sunday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1170, 'monday', 'Monday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1171, 'tuesday', 'Tuesday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1172, 'wednesday', 'Wednesday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1173, 'thursday', 'Thursday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1174, 'friday', 'Friday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1175, 'saturday', 'Saturday', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1176, 'select_weekends', 'Select Weekends', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1177, 'unique_roll', 'Unique Roll', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1178, 'classes_wise', 'Departments Wise', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1179, 'section_wise', 'Section Wise', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1180, 'start_from', 'Start From', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1181, 'digit', 'Digit', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1182, 'fees_carry_forward_setting', 'Fees Carry Forward Setting', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1183, 'due_days', 'Due Days', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1184, 'due_fees_calculation_with_fine_', 'Due Fees Calculation With Fine ', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1185, 'google_analytics', 'Google Analytics', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1186, 'statistics', 'Statistics', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1187, 'employees', 'Employees', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1188, 'classes', 'Departments', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1189, 'parent_menu', 'Parent Menu', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1190, 'active', 'Active', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1191, 'language_unpublished', 'Language Unpublished', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1192, 'create_section', 'Create Section', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1193, 'section_list', 'Section List', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1194, 'guardian_picture', 'Guardian Picture', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1195, 'payment_status', 'Payment Status', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1196, 'approved_and_enroll', 'Approved And Enroll', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1197, 'teachers_list', 'Teachers List', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1198, 'promotion_history', 'Promotion History', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1199, 'from_class', 'From Class', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1200, 'from_session', 'From Session', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1201, 'promoted_class', 'Promoted Class', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1202, 'promoted_session', 'Promoted Session', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1203, 'promoted_date', 'Promoted Date', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1204, 'disable_reason', 'Disable Reason', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1205, 'note', 'Note', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1206, 'no_fees_have_been_allocated', 'No Fees Have Been Allocated', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1207, 'header_title', 'Header Title', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1208, 'frontend_enable_chat', 'Frontend Enable Chat', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1209, 'backend_enable_chat', 'Backend Enable Chat', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1210, 'whatsapp_agent', 'Whatsapp Agent', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1211, 'agent', 'Agent', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1212, 'whataspp_number', 'Whataspp Number', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1213, 'weekend', 'Weekend', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1214, 'my_child', 'My Child', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1215, 'fees_pay_now', 'Fees Pay Now', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1216, 'instructions', 'Instructions', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` (`id`, `word`, `english`, `bengali`, `arabic`, `french`, `hindi`, `indonesian`, `italian`, `japanese`, `korean`, `dutch`, `portuguese`, `thai`, `turkish`, `urdu`, `chinese`, `afrikaans`, `german`, `greek`, `spanish`, `nepali`, `russian`, `danish`, `armenian`, `georgian`, `marathi`, `malay`, `punjabi`, `tamil`, `telugu`, `swedish`, `filipino`) VALUES
(1217, 'date_of_payment', 'Date Of Payment', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1218, 'reference', 'Reference', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1219, 'proof_of_payment', 'Proof Of Payment', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1220, 'pay', 'Pay', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1221, 'trx_id', 'Trx Id', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1222, 'submit_date', 'Submit Date', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1223, 'certificates', 'Certificates', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1224, 'default_template', 'Default Template', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1225, 'fields_setting', 'Fields Setting', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1226, 'terms_conditions', 'Terms Conditions', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1227, 'online_addmission', 'Online Addmission', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1228, 'fee', 'Fee', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1229, 'free', 'Free', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1230, 'fields', 'Fields', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1231, 'post_code', 'Post Code', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(1232, 'half_day', 'Half Day', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
(1, 'English', 'english', 1, '2018-11-15 11:36:31', '2024-02-17 01:12:35'),
(2, 'Bengali', 'bengali', 0, '2018-11-15 11:36:31', '2018-12-04 15:41:50'),
...
(1, 1, 'admin@email.com', '$2y$10$27EVadd0xPmyxD.TcXUTM.D/s8UbUYXZkyjvZXdx/ZE.VlXbbb0IS', 1, 1, '2024-02-20 21:13:11', '2024-02-16 20:18:44', NULL),
(2, 1, 'Demarcox', '$2y$10$SvPjskN.BNSJlrrHSKyD6.Vl/dquJwheTDATqF18/dtqm1NvAKlpC', 6, 1, NULL, '2024-02-17 00:42:59', NULL),
(3, 1, 'Demarco', '$2y$10$E3pi1JP8d7S9WyTTATQAlOfNDfpWSTdYymef9U2wsjtH7kZ2DDk1q', 7, 1, '2024-02-18 01:24:08', '2024-02-17 00:42:59', NULL),
(4, 2, 'Margot39', '$2y$10$ULUpvB/C6B3b8W6fls9SsemxQzKoFzDYBFYcM7Po82hIvsxwRj/we', 6, 1, '2024-02-18 01:48:20', '2024-02-18 00:45:34', NULL),
(5, 2, 'compddd', '$2y$10$4AhYIbDH3Z3wx7vLUy/LT.jlj18zed4mNlZQ9LcN2qD5QUkCJFVEu', 7, 1, '2024-02-18 01:49:10', '2024-02-18 00:45:34', NULL);
...
CREATE TABLE IF NOT EXISTS `modules_manage` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `offline_fees_payments` (
  ...
  `enc_file_name` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci,
...
CREATE TABLE IF NOT EXISTS `offline_payment_types` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
(1, 'Jayden', 'Rosenbaum', 'male', '2024-02-08', 'Eius', 'Louisiana', 'A+', '49', 'Fuga', '779 Alexanne Way', '16921 Rebecca Heights', '2024-02-17', 'San Mateo', 'North Dakota', '', '2', 'your.email+fakedata36689@gmail.com', '{\"school_name\":\"Madison Miller\",\"qualification\":\"Rem quibusdam perspiciatis magni.\",\"remarks\":\"Reiciendis possimus illo sunt.\"}', 'Demarco Marvin', 'Omnis molestias eveniet eligendi veniam.', 'Coty_Jacobson', 'Helen_Abshire', 'Hic animi accusantium exercitationem tenetur ea temporibus.', 'Odit deserunt reiciendis ', 'Similique earum pariatur dolores.', 'your.email+fakedata53625@gmail.com', '474', '6773 Maryjane Streets', 'Battle Creek', 'Utah', '', 2, 0, '0.00', '', 1, 1, '1', '2024-02-17 01:37:33', '4a5c4df17742eef2d2b79ba715bd78f8.jpeg', '2024-02-17 01:37:33'),
(2, 'Esmeralda', 'Doyle', '', '', '', NULL, '', '', '', '8981 Hickle Parkways', '6938 West Mount', '2024-02-19', 'North Uriel', '', '', '2', 'your.email+fakedata71263@gmail.com', '', 'nnn', 'kk', '', '', 'bbnn', '00', '0bnm', 'your.email+fakedata71263@gmail.com', '+93880943723', '8981 Hickle Parkways\r\n6938 West Mount', 'North Uriel', 'fd', '', 1, 0, '0.00', '', 1, 1, '1', '2024-02-19 23:20:46', '1b5a146d51a98d7708b57e9fc19362f0.png', '2024-02-19 23:20:46'),
(3, 'Lucy', 'Hintz', 'male', '', 'Ratione nemo doloremque cupiditate natus itaque vero voluptatum.', NULL, 'AB-', '499', 'Eum possimus magnam optio ipsum ad fugit.', '77214 Schowalter Court', '305 Gislason Island', '2024-02-19', 'Lodi', 'South Carolina', '', '2', 'your.email+fakedata74044@gmail.com', '{\"school_name\":\"Etha Rolfson-Reichel\",\"qualification\":\"Tempore dolorem animi magnam incidunt amet quibusdam veritatis dicta dicta.\",\"remarks\":\"Perspiciatis modi quaerat mollitia eius rerum.\"}', 'Floyd Wyman', 'Vero accusantium architecto beatae.', 'Queenie_Konopelski85', 'Jamaal_Dare74', 'Perspiciatis aspernatur similique ipsa deserunt.', 'Magni similique quibusdam', 'Ducimus fugit corporis error reiciendis minus illum accusantium illo nulla.', 'your.email+fakedata15660@gmail.com', '265', '3090 Max Trafficway', 'Country Club', 'Montana', '', 1, 1, '5000.00', '{\"name\":\"Esmeralda Claudine68 Doyle\",\"email\":\"your.email+fakedata71263@gmail.com\",\"post_code\":\"6576\",\"state\":\"fd\",\"address\":\"8981 Hickle Parkways\\r\\n6938 West Mount\",\"payment_method\":\"paystack\",\"remarks\":\"Admission Fees deposits online via Paystack Ref ID: 7658b5fc18659321b523eda400c17297\",\"date\":\"2024-02-19 23:38:37\"}', 1, 1, '1', '2024-02-19 23:36:45', '769a8f2c077b34228e0f7df51721499e.png', '2024-02-19 23:36:45');
...
CREATE TABLE IF NOT EXISTS `online_exam` (
  ...
  `limits_participation` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `online_exam_answer` (
  `id` int NOT NULL AUTO_INCREMENT,
  `student_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `online_exam_payment` (
  `id` int NOT NULL AUTO_INCREMENT,
  `student_id` int NOT NULL,
  `exam_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `online_exam_submitted` (
  `id` int NOT NULL AUTO_INCREMENT,
  `student_id` int NOT NULL,
  `online_exam_id` int NOT NULL,
...
(1, 'Demarco Marvin', 'Omnis molestias eveniet eligendi veniam.', 'Coty_Jacobson', 'Helen_Abshire', 'Hic animi accusantium exercitationem tenetur ea temporibus.', '90', 'Similique earum pariatur dolores.', 'your.email+fakedata53625@gmail.com', '474', '6773 Maryjane Streets', 'Battle Creek', 'Utah', 1, 'defualt.png', NULL, NULL, NULL, '2024-02-17 00:42:59', NULL, 0),
(2, 'Demarco Marvin', 'Omnis molestias eveniet eligendi veniam.', 'Coty_Jacobson', 'Helen_Abshire', 'Hic animi accusantium exercitationem tenetur ea temporibus.', '2', 'Similique earum pariatur dolores.', 'your.email+fakedata53625@gmail.com', '474', '6773 Maryjane Streets', 'Battle Creek', 'Utah', 1, 'defualt.png', NULL, NULL, NULL, '2024-02-18 00:45:34', NULL, 0);
...
CREATE TABLE IF NOT EXISTS `payment_config` (
  ...
  `flutterwave_sandbox` tinyint NOT NULL DEFAULT '0',
  `flutterwave_status` tinyint NOT NULL DEFAULT '0',
...
(1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, 'sk_test_5e3952b2ca32a4c9bb957d40dbbb3d1343455ba6', 0, '', '', 0, 0, '', '', 0, 0, '', '', '', 0, 0, '', '', 0, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, 0, '2024-02-16 23:36:02', NULL),
(2, NULL, NULL, NULL, NULL, NULL, 0, NULL, '', NULL, 0, NULL, NULL, NULL, 0, 'sk_test_5e3952b2ca32a4c9bb957d40dbbb3d1343455ba6', 1, '', '', 0, 0, '', '', 0, 0, '', '', '', 0, 0, '', '', 0, 0, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, 1, '2024-02-19 22:30:50', NULL);
...
CREATE TABLE IF NOT EXISTS `postal_record` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `product_issues_details` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `promotion_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `student_id` int NOT NULL,
  `pre_class` int NOT NULL,
  `pre_section` int NOT NULL,
  `pre_session` int NOT NULL,
  `pro_class` int NOT NULL,
  `pro_section` int NOT NULL,
  `pro_session` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  `group_id` int NOT NULL,
  `question` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `opt_1` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `opt_2` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `opt_3` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `opt_4` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `questions_manage` (
  `id` int NOT NULL AUTO_INCREMENT,
...
('027vl306q62f39k9ok2t75vv74ipqg3s', '::1', 1708124357, ),
('114dh1ms66ihk887rraldupll48vlt7i', '::1', 1708131726, ),
('15fqm2h8k6lguo95phk1d4e3232fo71m', '::1', 1708382695, ),
('1v4thgl1gjnv5rev30tiul9h4hu9ci5q', '::1', 1708215343, ),
('1vf4hfno0ir540o5g1td1tict3amgkpg', '::1', 1708122120, ),
('27h84ki6ifb6blfnffssmvbfjfhm86fu', '::1', 1708129509, ),
('3jleubgcdgde1j50s8dng2vn9slipmf0', '::1', 1708126901, ),
('4oi0usaqc53ct1klli00dmiuhhdsuqd0', '::1', 1708380849, ),
('55e1bari7lb2vk1fh6gbaspsoqb8sqmg', '::1', 1708128830, ),
('5or14an1rtb5a5lf9300fvir0ih38vkn', '::1', 1708129817, ),
('6ddd6p50gqlkbnakhb57qenc872ki4a8', '::1', 1708384111, ),
('6jfpnmcfrovn19u3ocf0j0ccsg3b92eg', '::1', 1708216168, ),
('7j1pchlbqgolap50q77ueoe9nfqt8bke', '::1', 1708130439, ),
('8bna43basvuhtu4m592m62927ge6snbp', '::1', 1708215713, ),
('8eshaf0pvst0atg8bqltn4uvjc7o13rm', '::1', 1708383914, ),
('8ndmjlr2i1018qe7ulfhe4tesk31lfiq', '::1', 1708380546, ),
('8nn9tq8t1m37iva9nt8ejr1qkrms520s', '::1', 1708373978, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383337333937383b72656469726563745f75726c7c733a35323a22687474703a2f2f6c6f63616c686f73742f7363686f6f6c2f63657274696669636174652f67656e65726174655f73747564656e74223b),
('8rdmtdpplsisvd1tp98ftmrgctn65m6v', '::1', 1708215741, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383231353734313b72656469726563745f75726c7c733a34323a22687474703a2f2f6c6f63616c686f73742f7363686f6f6c2f73657474696e67732f756e6976657273616c223b),
('8s1kf8ogt68ernl6t2fcfg3epqlncaoe', '::1', 1708381248, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383338313133313b),
('8s7c8u5uok4mveti5126nr8idqatahs0', '::1', 1708124961, ),
('8ug54hic1m8oca0n52cabvd3flm5m6en', '::1', 1708131604, ),
('8vtbt9iqrimilqjkmh0hbjmq1gbf3si3', '::1', 1708217780, ),
('9tqhti4s8dtv95eechtg9sgotkn1akeo', '::1', 1708121516, ),
('aq89m7s43ru5kmckf48bvnkn33fns50q', '::1', 1708121165, ),
('b4cjm7hrjqdfmv3kchonb5qj0qfkiq9a', '::1', 1708131375, ),
('b9n33ckq87lql4nft3s868mqugklumie', '::1', 1708216845, ),
('bnl2tuogd1ulhu8c0fuhjp21ke3gd1qd', '::1', 1708217789, ),
('c1pql6eeirfrus1726kjru4mj4og1b9q', '::1', 1708460707, ),
('d3gep25frpcpr0eleno2jv3g41vuan3k', '::1', 1708216327, ),
('dqsvpdmcq4vi4lume4q6a7gqtqahlaar', '::1', 1708383198, ),
('dujco8uhogoabjc98bihrh5supqqes7t', '::1', 1708130746, ),
('e6gd6m23o8r523l4u5b9d0s4ak45j3lv', '::1', 1708130994, ),
('eh7o359uprpo3isd88q5dqn17qm6suam', '::1', 1708241318, ),
('erpa4ajt0k80kfv4um5iitjlviutvm72', '::1', 1708460717, ),
('fkffihhfljtrpd87i0b1rk8g4vjqptrt', '::1', 1708125301, ),
('fpoprsogcr8hmgdkdhiabnkpf7q8ua26', '::1', 1708217264, ),
('hbblu347jkqsv3s90kqt74tosm4hh1h7', '::1', 1708120356, ),
('hf9jctvrbujplllamoim515717sfnitc', '::1', 1708122594, ),
('hhrkp59bq8b5m5ihhhmioanknq4ds5u6', '::1', 1708217592, ),
('il1e1hblehm9q3ff37ugalfn4g4bgene', '::1', 1708173272, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383137333236393b72656469726563745f75726c7c733a33333a22687474703a2f2f6c6f63616c686f73742f7363686f6f6c2f64617368626f617264223b),
('ilect4qce25vks65vmb58ip9lhvoie3t', '::1', 1708451668, ),
('j1aeu16fv6mns6n6j92j7coipalpfiqv', '::1', 1708382205, ),
('j7l2cfc928h9n1ljn6b7ml8mb8e5nv5t', '::1', 1708129196, ),
('jd0mkthqfs455a3js0mgfav9qi2gmen0', '::1', 1708450973, ),
('jhsj8oi3pppor6o4pqgdt9fs23nsg2fe', '::1', 1708126591, ),
('jlb0mjnrhp21vk5pqpfv93le1fh5bo1k', '::1', 1708241487, ),
('jmdlfrc36puarr3e3tk72op8ksj653ql', '::1', 1708123009, ),
('kf6tiksmajb31d9huenl8f3mv7tfl22g', '::1', 1708131049, ),
('kkofvmjjrn5t9ne3fi6njvhop7ms9rsl', '::1', 1708215724, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383231353634303b72656469726563745f75726c7c733a34323a22687474703a2f2f6c6f63616c686f73742f7363686f6f6c2f73657474696e67732f756e6976657273616c223b),
('kl2smf9t163l8m01bueqpsfnl59f1ba8', '::1', 1708240697, ),
('ks2ckvk1lc6219ohr4ce8g90100gb4am', '::1', 1708240086, ),
('l1rhgq1lj093ef54e7pk6l2htedr5uhm', '::1', 1708123694, ),
('lbonil0mot009p7l3f06f174v58iairm', '::1', 1708124047, ),
('lglukcf55pr9u0gmmg6ss94j0gk6e561', '::1', 1708451291, ),
('lleagqdrlprsdddlk1mvr7ul85uu8p92', '::1', 1708124659, ),
('ltqnkaukfu15k7ddm1mngmjub77un94d', '::1', 1708130130, ),
('nq4b6k50pjfhk91s38ip5mq6th2ahmde', '::1', 1708381161, ),
('opro4ivpgterrc0dhtgko5epdqt0l466', '::1', 1708125976, ),
('ou1ppeaah3579tcuued93vjljkfj1q4s', '::1', 1708124555, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383132343530333b),
('pfpajpss1g3kftgcoae56ak85fuisuiu', '::1', 1708217183, ),
('qn51vijdurueaspa7khqufe3q80u68th', '::1', 1708286222, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383238363232313b72656469726563745f75726c7c733a34303a22687474703a2f2f6c6f63616c686f73742f7363686f6f6c2f75736572726f6c652f696e766f696365223b),
('rieaoagv5m1et838iq4cbmo5dl3j3ve3', '::1', 1708131715, ),
('rp5tvs2i6s1dnf7on54nbcslc30io6gk', '::1', 1708217970, ),
('rt80ov4lsitt4l4205mv82u5keldqssf', '::1', 1708216018, ),
('sa10imjcphif4a0u6ghk7r5jcfs2iqpi', '::1', 1708451611, ),
('sckn9vmvq3n12g2u51k9opi2a5ghdnsd', '::1', 1708450663, ),
('sjv4631mehmsl4sql3kppmh143e4vf45', '::1', 1708429002, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383432393030303b72656469726563745f75726c7c733a35393a22687474703a2f2f6c6f63616c686f73742f7363686f6f6c2f636172645f6d616e6167652f67656e65726174655f73747564656e745f696463617264223b),
('sn3t7lg0fnt5r94i12oilb5d54nh6qig', '::1', 1708124984, 0x5f5f63695f6c6173745f726567656e65726174657c693a313730383132343938343b),
('uan9f6tk3vgs2qcaep47ibelokkft6mo', '::1', 1708128519, ),
('ufdd7r1roqaes8fa4r2m854dk53ck79m', '::1', 1708126283, ),
('ufpnf1i900kttgbhtfa6fht1go20o92o', '::1', 1708381822, ),
('v195s9gsfmt1f4hk1sep93f8un7tbgb5', '::1', 1708131604, );
...
(1, 'd0e4329', 'admin boss', 0, '', NULL, NULL, 0, '2024-02-16', '', '', '', '', '', '', '', 'admin@email.com', 0, NULL, NULL, NULL, NULL, NULL, '2024-02-16 20:18:44', NULL);
...
(1, 'SRCI-00000001', '2024-02-17', 'Jayden', 'Rosenbaum', 'male', '2024-02-08', 'Eius', 'Louisiana', 'A+', 'Fuga', '779 Alexanne Way', '16921 Rebecca Heights', 'San Mateo', 'North Dakota', '49', 2, 'your.email+fakedata36689@gmail.com', 1, 0, 0, 0, 0, '{\"school_name\":\"Madison Miller\",\"qualification\":\"Rem quibusdam perspiciatis magni.\",\"remarks\":\"Reiciendis possimus illo sunt.\"}', '845f22028aa76a8e54027b524e888bb0.jpg', '2024-02-17 00:42:59', NULL),
(2, 'SRCI-00000002', '2024-02-18', 'Jayden', 'Rosenbaum', 'male', '2024-02-08', 'Eius', 'Louisiana', 'A+', 'Fuga', '779 Alexanne Way', '16921 Rebecca Heights', 'San Mateo', 'North Dakota', '49', 2, 'your.email+fakedata36689@gmail.com', 2, 0, 0, 0, 0, '{\"school_name\":\"Madison Miller\",\"qualification\":\"Rem quibusdam perspiciatis magni.\",\"remarks\":\"Reiciendis possimus illo sunt.\"}', 'defualt.png', '2024-02-18 00:45:34', NULL);
...
CREATE TABLE IF NOT EXISTS `student_admission_fields` (
  `id` int NOT NULL AUTO_INCREMENT,
  `fields_id` int NOT NULL,
  `status` tinyint NOT NULL DEFAULT '1',
  `required` tinyint NOT NULL DEFAULT '0',
...
(1, 2, '2024-02-20', 'P', '', 1, '2024-02-20 20:14:12', NULL);
...
CREATE TABLE IF NOT EXISTS `student_fields` (
  ...
  `default_required` tinyint NOT NULL DEFAULT '1',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
(1, 1, 1, '1', 0, 1, 4, '2024-02-17 00:14:06', NULL);
...
CREATE TABLE IF NOT EXISTS `transactions_links_details` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `visitor_purpose` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `branch_id` int NOT NULL,
  PRIMARY KEY (`id`)
...
(1, 'Clemmie Larkin', 'defualt.png', 'Neque magni reprehenderit eligendi nostrum perferendis fuga aperiam.', '+2347017467902', '11:20:00', '01:09:00', 'saturday', 1, 1, '2024-02-20 18:49:33');
